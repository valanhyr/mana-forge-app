...
import DeckTable, { type Deck } from "../../components/ui/DeckTable";
import CardGrid, { type CardDisplayData } from "../../components/ui/CardGrid";
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-zinc-950 rounded-xl border border-zinc-800 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-zinc-500 uppercase">Backend Java</p>
          ...
          <div className="mt-8 pt-8 border-t border-zinc-800">
            ...
            <DeckTable
              ...
              onDuplicate={(id) => console.log("Duplicate deck", id)}
