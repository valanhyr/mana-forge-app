      ...
      >
        ...
        {sent ? (
          <div className="p-8 flex flex-col items-center gap-4 text-center">
            ...
            <button
              onClick={handleClose}
              className="mt-2 px-6 py-2 bg-orange-600 hover:bg-orange-500 text-white font-bold rounded-xl transition-all"
            >
              OK
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <span className="absolute right-3 bottom-2 text-xs text-zinc-600">
                  {summary.length}/100
                </span>
              </div>
            </div>
